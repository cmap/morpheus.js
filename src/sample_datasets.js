morpheus.SampleDatasets = function (options) {
  ...
  fetch('https://software.broadinstitute.org/morpheus/preloaded-datasets/tcga/tcga_index.txt').then(function (response) {
    ...
    depMapDatasets.push({
      ...
      file: 'portal-Avana-2018-04-11.csv',
      help: 'The latest (2018Q1) release of 391 cell lines screened with the Avana 1.0 library.'
    });
    depMapDatasets.push({
      name: 'CRISPR (Broad GeCKO)',
      file: 'portal-GeCKO-2018-04-11.csv',
    ...
    depMapDatasets.push({
      ...
      file: 'portal-RNAi_Ach-2018-04-11.csv',
    ...
    depMapDatasets.push({
      ...
      file: 'portal-RNAi_Nov_DEM-2018-04-11.csv',
      help: ' A RNAi dataset containing 398 cell lines generated by Novartis published in McDonald III et al., Cell, 2017. Project DRIVE: A Compendium of Cancer Dependencies and Synthetic Lethal Relationships Uncovered by Large-Scale, Deep RNAi Screening'
    });
    depMapDatasets.push({
      name: 'GENE EXPRESSION',
      file: 'portal-expression-2018-04-11.csv',
      help: 'CCLE RNAseq gene expression data (RPKM)'
    });
    depMapDatasets.push({
      name: 'MUTATION',
      file: 'portal-mutation-2018-04-11.maf.txt',
      help: 'Merged mutation calls (coding region, germline filtered)'
    });
    depMapDatasets.push({
      name: 'COPY NUMBER BY GENE',
      file: 'portal-copy_number_relative-2018-04-11.csv',
    ...
    for (var j = 0; j < depMapDatasets.length; j++) {
      ...
      exampleHtml.push('<label><input type="checkbox" style="margin-left:4px;" data-toggle="dataTypeToggle" data-file="' + info.file + '"' + '>' + info.name + '</label>');
    }
